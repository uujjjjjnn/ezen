...
//		security.authorizeRequests().antMatchers("/admin/**").hasRole("ADMIN");
		...
		// 스프인부트의 로그인화면이 아니라 사용자로그인화면을 제공할 경우는 
		// loginPage()메서드를 추가
	...
	// 사용자   : user
	// 비밀번호 : Using generated security password: 8ce324d4-4fa8-4fe7-9b44-abad74490cfe
...
//			.withUser("manager")
//			.password("{noop}12345") // {noop}는 스프링이 문자그대로 비밀번호 인식하게 하는 옵션
//			.roles("MANAGER");
//		
