...
const Hook01_02useState = () => {
  ...
  // 변수상태의 초기화 방법 3가지
  // const [users, setUsers] = useState(['손흥민', '이강인', '김민재']); // 직접 입력
  // const [users, setUsers] = useState(fn_heavyWork());    // 변수 상태가 변경할 때 마다 실행
  const [users, setUsers] = useState(() => fn_heavyWork()); // 콜백함수는 초기화할 때 한 번만 실행
