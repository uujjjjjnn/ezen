...
<body>
		...
		<form action="updateBoard2.jsp" method="post" class="row g-3">
		  ...
		  <div class="col-12">
		    ...
		    <input style="height:50px" type="text" class="form-control" name="subject" value="<%= subject%>">
		  </div>	
		  <div class="col-12">
		    <label for="content" class="form-label">content</label>
		    <input style="height:400px" "type="text" class="form-control" name="content" value="<%= content%>">
		  </div>

		  
	  <div class="col-12" >
	  	<input type="hidden" name="writer" value=<%= writer %>  />
		<input type="submit" class="btn btn-warning mt-sm-2" value="게시글수정"/>
