<%@page import="com.lec.web.service.GetMessageListService2"%>
...
<%
	GetMessageListService2 MessageListService2 = GetMessageListService2.getInstance();
	List<Message> view_data = MessageListService2.getMessageList2();
