...
<body>
	...
	<%
		...
		Cookie cookie2 = new Cookie("path2", URLEncoder.encode("경로:/jsp01_basic/jsp08_cookies/path1", "utf-8"));
		response.addCookie(cookie2);
		
		
		// 3. 경로를 root(/)로 지정하고 쿠키를 추가
		Cookie cookie3 = new Cookie("path3", URLEncoder.encode("경로:/jsp01_basic/jsp08_cookies/path1", "utf-8"));
		cookie3.setPath("/");
		response.addCookie(cookie3);
		
		// 4. 경로를 path2로 지정해서 쿠키를 추가
		Cookie cookie4 = new Cookie("path4", URLEncoder.encode("경로:/jsp01_basic/jsp08_cookies/path2", "utf-8"));
