...
<!-- 
	...
	1. 디렉티브(Directive, 지시자(어))
		...
		c. include : jsp페이지의 특정영역으로 다른 jsp페이지를 불러올 때
					 예를들어서 Header, Footer처럼 고정된 페이지를 공통으로 사용되는 페이지를 로딩
		
	2. 스크립트(Script)
	
		jsp에서 jsp파일을 동적으로 생성하기 위해 사용되는 것으로 스크립트 요소를 사용하면 사용자가 jsp페이지에 입력한 정보를
		DB에 저장할 수 있고 DB에서 데이터를 읽어서 출력할 수도 있다.
	...
	3. 기본객체(implicit object, 내장객체)
		...
		JSP는 웹애플리케이션 프로그래밍을 하는 필요한 기능을 제공해주는 기본객체를 제공한다.
