...
<!-- 
	...
	request기본객체는 jsp페이지에서 가장 많이 사용되는 객체로서 웹브라우저의 요청과 관련이 있는 객체이다.
	웹브라우저에서 웹사이트주소를 입력하면 웹브라우저는 해당 주소의 웹서버에 연결한 후 요청정보를 전송하는데
	이 요청 정보를 웹 서버에 전달하는 객체가 request객체이다.
	...
	A. request객체가 제공하는 기능
		...
		4. 클라이언트가 전송한 요청헤더정보(http규약에 따른 정보 등..)
		5. 클라이언트가 전송한 쿠키정보
		6. 속성처리정보
	...
	D. request객체의 메서드
		...
		7. getRequestURI() : 웹브라우저가 요청한 URI정보
