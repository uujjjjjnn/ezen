...
<!-- 
	...
	이 구조를 모른다면 제대로 동작하는 프로그램을 개발할 수 없개 된다.
	...
	... WEB_INF/lib 	: 웹애플리케이션에서 사용하는 라이브러리파일이 위치함(예: ojdbc.jar)
	... WEB_INF/사용자 	: 사용자폴더, css, js, html등 사용자가 작성한 파일이 위치하는 폴더
	...
	B. 웹애플리케이션의 배포(deploy)
		...
		b. war파일형식으로 압축해서 배포하는 방법
			... jdk의 jar.exe명령을 사용해서 war파일을 생성
			... 실행방법 c:/jar.exe cvf jsp01_basic.war
			... 상기명령 대신에 이클립스를 이용 : 프로젝트이름 우클릭 > export > war file
...
<body>
	...
	<a href="jsp03_process/jsp01_process.jsp">불가능</a> <br> 
