...
<!-- 
	...
	2. Action Tag의 종류
		...
		jsp:include : 외부에서 다른 페이지를 현재 페이지에 포함(페이지의 모듈화)
		jsp:forward : 다른 페이지로 이동명령, 흐름을 제어가능
		jsp:useBean : JSP페이지에 Java Beans를 설정 (예를들어 BoardVO)
		jsp:setProperty : Java Beans의 값을 설정(예를들어 BoardVO의 setter역할)
		jsp:getProperty : Java Beans의 값을 설정(예를들어 BoardVO의 getter역할)
