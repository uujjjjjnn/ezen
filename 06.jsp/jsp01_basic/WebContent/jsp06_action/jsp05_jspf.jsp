...
<!-- 
	...
	include 디렉티브를 통해 다른 jsp파일에서 데이터를 전달받을 수 있다.
	전달받은 데이터가 jsp파일일 경우 일반 jsp파일과 구분하기 위해서 통상적으로 확장자를 jspf로 사용한다.
	
	파일확장자를 jsp로도 사용할 수 있지만 JSP Fragment 즉, jsp파일의 소스코드조각파일을 의미한다.
	
	페이지 디렉티브에서 컨텐츠타입을 지정하고 있는데 이것을 포함하는 파일일지라도 컨텐츠 타입에 알맞게
