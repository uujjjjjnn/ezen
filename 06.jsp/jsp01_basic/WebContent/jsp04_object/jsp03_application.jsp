...
<!-- 
	...
	예를 들어 application객체를 사용해서 초기설정정보, 서버정보, 웹애플리케이션에서 제공하는 정보를 공통으로 공유해서 사용할 수 있다.
	...
	이 파일은 반드시 WEB-INF폴더에 위치해야 한다. 다른 폴더에 위치하게 될 경우 이 파일은 인식하지 못한다.
...
<body>
	...
	<h3>서버 메이저 버전 정보 : <%= application.getMajorVersion() %></h3>
	<h3>서버 마이너 버전 정보 : <%= application.getMinorVersion() %></h3>
