...
public class EnumMain {
	...
	public static void main(String[] args) {
		...
		// Week today = new Week(); 	// enum은 객체를 생성할 수 없다.(객체화, 인스턴스instance화 할 수 없다)
		// Week열거타입을 선언했다면 열거타입을 호출해서 사용할 수 있다.
		// 열거타입은 하나의 데이터타입(참조타입, 사용자가 정의한 새로운 데이터타입)이므로 변수로 선언하고 사용해야 한다.
