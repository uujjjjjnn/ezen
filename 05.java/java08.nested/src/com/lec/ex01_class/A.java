...
public class A {
	...
	public class B {
		...
		// 메서드
		void b_method() { System.out.println("b_method() 호출 -> " + b_field); }
	...
	public static class C {
		...
		// static void c_method2() { System.out.println("C.c_method1() 호출 -> " + c_field1); }
		// 메모리에 올라갔는지 여부를 알 수 없어서 접근 불가
		
		
	}

	// 3. 로컬중첩클래스 (메서드가 생성되야 D생성되기 때문에 static, public, private 못 붙임)
	public void a_method() {
		class D {
			...
			void d_method1() {
				System.out.println("D.d_method1() 호출");
			}
