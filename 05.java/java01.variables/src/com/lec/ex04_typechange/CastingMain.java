...
public class CastingMain {
	...
	public static void main(String[] args) {
		...
		// 3. 연산 시 형변환
		double d2 = 10 + 3.141592; 	// int(10)이 double(10.0)으로 자동형변환 후에 연산
		System.out.println(d2 + "의 값 = " + d2);
		
		d2 = 10 + (int) 3.141592; 	// double(3.141592)이 int(3)로 강제형변환 후에 연산 후 double로 자동형변환
		System.out.println(d2 + "의 값 = " + d2);
		
		d2 = (int) (10 + 3.141592); 	
		// int(10)이 double(10.0)으로 자동형변환 후 연산결과(13.141592)가 int로 강제형변환 후 double로 자동형변환 
