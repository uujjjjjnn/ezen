...
public class InfinityNaNCheckMain {
	...
	public static void main(String[] args) {
		...
		// 그러나 실수타입인 경우 0.0 or 0.0f로 나누면 예외가 발생되지 않고 나누기연산의 결과 무한대(Infinity) 값을 가지고
		// 나머지(%)연산의 결과는 NaN(Not a Number) 결과를 리턴한다.
		...
		// Java에서는 프로그램에서 /, % 연산의 결과가 Infinity or NaN인지를 확인하려면 Double.isInfinite(), Double.inNaN() 메서드를 이용한다.
