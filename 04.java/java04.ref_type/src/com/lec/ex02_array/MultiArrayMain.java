...
public class MultiArrayMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("2차원 배열의 첫번째 배열 크기 = " + mathScores[0].length);
		System.out.println("2차원 배열의 두번째 배열 크기 = " + mathScores[1].length);
		System.out.println();
		...
		// System.out.println("2차원 배열의 첫번째 배열 크기 = " + engScores[0].length);
		// System.out.println("2차원 배열의 두번째 배열 크기 = " + engScores[1].length); 	// 아직 null임
		...
		System.out.println("2차원 배열의 첫번째 배열 크기 = " + engScores[0].length);
		System.out.println("2차원 배열의 첫번째 배열 크기 = " + engScores[1].length);
		System.out.println("2차원 배열의 첫번째 배열 크기 = " + engScores[2].length);
		System.out.println();
